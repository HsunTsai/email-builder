  ...
  <BaseSidebarPanel title="Divider block">
    <ColorInput
      ...
      @change="
        handleUpdateData({
          ...data,
          props: { ...data.props, lineColor: $event },
        })
      "
    />
    <SliderInput
      ...
      @change="
        handleUpdateData({
          ...data,
          props: { ...data.props, lineHeight: $event },
        })
      "
    />
...
import {
  ...
  DividerPropsSchema,
} from "@flyhub/email-block-divider";
...
const lineColor = computed(
  () => props.data.props?.lineColor ?? DividerPropsDefaults.lineColor,
);
const lineHeight = computed(
  () => props.data.props?.lineHeight ?? DividerPropsDefaults.lineHeight,
);
