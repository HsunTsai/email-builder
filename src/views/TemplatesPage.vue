    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        ...
        >
          <!-- Template Preview -->
          <div
            class="aspect-w-3 aspect-h-4 bg-gray-100 relative overflow-hidden"
          >
            <div
            ...
            >
              <button
                class="btn btn-primary opacity-0 group-hover:opacity-100 transform scale-95 group-hover:scale-100 transition-all duration-300"
              >
                使用此模板
              </button>
            </div>
              ...
              <div class="flex items-center space-x-2">
                <div class="flex -space-x-1">
                  <div
                    ...
                    :class="
                      n <= template.rating ? 'bg-yellow-400' : 'bg-gray-200'
                    "
                  ></div>
                </div>
      ...
      >
        <button class="btn-outline px-8 py-3">載入更多模板</button>
      </div>

      <!-- Router Info -->
      <div
        class="mt-12 bg-white rounded-lg shadow-sm border border-gray-200 p-6"
      >
        <h3 class="text-lg font-semibold text-gray-900 mb-4">路由資訊</h3>
        <div class="space-y-2 text-sm">
          <div class="flex items-center justify-between">
            <span class="text-gray-600">當前路由:</span>
            <code class="bg-gray-100 text-gray-800 px-2 py-1 rounded">{{
              $route.path
            }}</code>
          </div>
          <div class="flex items-center justify-between">
