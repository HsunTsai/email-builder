      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <router-link
              to="/"
              class="flex items-center space-x-3 text-gray-900 hover:text-blue-600 transition-colors"
            >
          ...
          <div class="hidden md:flex space-x-1">
            ...
            <router-link
              to="/editor"
              class="nav-link"
              :class="{ 'nav-link-active': $route.name === 'Editor' }"
            >
              編輯器
            </router-link>
          </div>
          ...
          <div class="hidden md:block">
            <span
              class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded font-mono"
            >
              {{ baseUrl }}
            </span>
          </div>
